...
},{}],"highlightcomment.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var HighlightComment = /*#__PURE__*/function () {
  function HighlightComment(comment) {
    _classCallCheck(this, HighlightComment);

    this.commentText = comment["commentText"], this.username = comment["username"], this.userId = comment["userId"], this.createdAt = comment["createdAt"];
  }

  _createClass(HighlightComment, null, [{
    key: "createComment",
    value: function createComment(commentData) {
      ...
      var newComment = new HighlightComment(comment);
      HighlightComment.all.push(newComment);
    }
  }, {
    key: "createNewComment",
    value: function createNewComment(highlightId, userId, commentText) {
      var data = {
        comment: {
      ...
      fetch("http://localhost:3000/highlights/".concat(data["user_id"], "/comments"), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    key: "getAllCommentsSortedNewestToOldest",
    value: function getAllCommentsSortedNewestToOldest(commentsArray) {
      commentsArray.forEach(function (comment) {
        return HighlightComment.createComment(comment.attributes);
      });
    }
  }, {
    key: "appendNewComment",
    value: function appendNewComment(insertPosition, comment) {
      ...
      newCommentDiv.innerHTML = "\n      <div class=\"flex space-x-8\">\n        <span class=\"text-xs\">".concat(comment.username, " says...</span>\n        <span class=\"text-xs\">").concat(new Date(comment.createdAt).toLocaleString(), "</span>\n      </div>\n      <p class=\"text-md\">").concat(comment.commentText, "</p>\n    ");
...
_defineProperty(HighlightComment, "all", []);
...
var Team = /*#__PURE__*/function () {
  function Team(team) {
    ...
    this.id = team["id"];
    this.school = team["school"], this.nickname = team["nickname"], this.shorthandName = team["shorthand_name"], this.realLifeRecordVsArkansas = team["real_life_record_vs_arkansas"], this.winsInGame = team["wins_in_game"], this.lossesInGame = team["losses_in_game"], this.description = team["description"], this.mascot = team["mascot"], this.wackA = team["wack_a"], this.image = team["image"];
  }

  _createClass(Team, [{
    key: "showTeamAndMascotDetails",
    value: function showTeamAndMascotDetails() {
      var _this = this;

      // remove teamDetails if they exist
      removeGameSettings();
      removeTeamDetails();
      var mascotId = document.querySelector(".mascot-image").dataset.mascotId;
      var mascotObject = Mascot.all.find(function (element) {
        return _this.id == mascotId;
      });
      document.querySelector("#wack-a-button").innerText = "Whack-a-".concat(this.wackA);
      var teamOverviewDiv = document.createElement("div");
      teamOverviewDiv.className = "w-full h-full flex flex-col align-center space-y-8 pt-6";
      teamOverviewDiv.innerHTML = "\n      <h1 class=\"text-center text-4xl font-bold\">".concat(this.shorthandName, " ").concat(this.nickname, "</h1>\n      <div class=\"flex justify-center\">\n        <img class=\"text-center self-center items-center content-center\" src=\"").concat(this.image, "\" width=\"500\">\n      </div>\n      <div>\n        <p class=\"text-center font-bold text-md\">Rivalry Overview<p>\n        <p class=\"text-center\">").concat(this.description, "</p> \n      </div>\n      <div>\n        <p class=\"text-center font-bold text-md\">Fun Fact<p>\n        <p class=\"text-center\">").concat(this.funFact, "</p>\n      </div>\n      <p class=\"text-center\"><span class=\"font-bold text-lg mr-4\">Series Record:</span><span>").concat(this.realLifeRecordVsArkansas, "</span></p>\n    ");
      document.querySelector("div#main-div").firstElementChild.appendChild(teamOverviewDiv);
    }
  }], [{
    key: "getAllTeams",
    value: function getAllTeams() {
      fetch("http://localhost:3000/teams").then(function (resp) {
        return resp.json();
      }).then(function (json) {
        return Team.addTeams(json);
      });
    }
  }, {
    key: "addTeams",
    value: function addTeams(json) {
      json.data.forEach(function (teamData) {
        var team = {};
        team["id"] = teamData.id, team["school"] = teamData.attributes.school, team["nickname"] = teamData.attributes.nickname, team["shorthand_name"] = teamData.attributes.shorthand_name, team["real_life_record_vs_arkansas"] = teamData.attributes.real_life_record_vs_arkansas, team["wins_in_game"] = teamData.attributes.wins_in_game, team["losses_in_game"] = teamData.attributes.losses_in_game, team["description"] = teamData.attributes.description, team["wack_a"] = teamData.attributes.wack_a, team["image"] = teamData.attributes.image;
        var newTeam = new Team(team);
        Team.all.push(newTeam);
      });
      json.included.forEach(function (mascotData) {
        return Mascot.addMascot(mascotData);
      });
...
var UserHighlight = /*#__PURE__*/function () {
  function UserHighlight(userHighlight) {
    _classCallCheck(this, UserHighlight);

    this.userId = userHighlight["userId"], this.highlightId = userHighlight["highlightId"];
  }

  _createClass(UserHighlight, null, [{
    key: "createNewUserHighlight",
    value: function createNewUserHighlight(json) {
      debugger; // this happens right after a new Highlight is created
      ...
      fetch("http://localhost:3000/users/".concat(data["user_id"], "/user_highlights"), {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    key: "createUserHighlights",
    value: function createUserHighlights(json) {
      UserHighlight.all = [];
      json.forEach(function (userHighlight) {
        var newObject = {};
        newObject["userId"] = userHighlight.user_id;
        newObject["highlightId"] = userHighlight.highlight_id;
        var newUserHighlight = new UserHighlight(newObject);
        UserHighlight.all.push(newUserHighlight);
      });
    }
  }, {
    key: "disableHighlightsThatAreNotUserHighlights",
    value: function disableHighlightsThatAreNotUserHighlights() {
      var currentUserId = document.querySelector("div#current-user-info").dataset.currentUser;
      fetch("http://localhost:3000/users/".concat(currentUserId, "/user_highlights")).then(function (resp) {
        return resp.json();
      }).then(function (json) {
        return UserHighlight.createUserHighlights(json);
      }).then(function (x) {
        return UserHighlight.disableHighlights();
      });
    }
  }, {
    key: "disableHighlights",
    value: function disableHighlights() {
      var highlights = document.querySelectorAll(".all-highlights");
      var highlightIdsForUserHighlights = UserHighlight.all.map(function (uh) {
        return uh.highlightId;
      });
      highlights.forEach(function (highlight) {
        if (!highlightIdsForUserHighlights.includes(parseInt(highlight.dataset.highlightId))) {
          var newHighlight = highlight.cloneNode(true);
...
var _highlightcomment = _interopRequireDefault(require("./highlightcomment"));

var _mascot = _interopRequireDefault(require("./mascot"));

var _team = _interopRequireDefault(require("./team"));

var _userHighlight = _interopRequireDefault(require("./userHighlight"));
...
window.addEventListener("DOMContentLoaded", function () {
  document.querySelector("#highlights-button").addEventListener("click", _highlight.default.displayHighlights);
  document.querySelector("#new-highlight-button").addEventListener("click", _highlight.default.addANewHighlight);

  _team.default.getAllTeams();
...
function countDownToStartGame(mascot) {
  ...
  gameDetails.gameTeam = _team.default.all.find(function (element) {
...
function displayResultsAndMedia() {
  ...
  _userHighlight.default.createNewUserHighlight(highlight);
...
function displayHighlightDetails(json) {
  var highlight = _highlight.default.createHighlight(json.data);
  ...
  iframe.parentElement.parentElement.parentElement.querySelector("span").addEventListener("click", function () {
    ...
    _highlightcomment.default.all = [];
  }); // adding comments

  _highlightcomment.default.getAllCommentsSortedNewestToOldest(json.included);

  _highlightcomment.default.all.forEach(function (comment) {
    return _highlightcomment.default.appendNewComment("afterbegin", comment);
  ...
  document.querySelector("form#new-comment-form").addEventListener("submit", function (event) {
    ...
    _highlightcomment.default.createNewComment(highlightId, userId, commentText);
  });
}
...
function determineGameWinner() {
  if (gameDetails.scoreboard >= gameDetails.totalRivals / 2) {
    ...
    gameDetails.winner = _team.default.all.find(function (team) {
...
function displayGameSettings() {
  ...
  var mascot = _mascot.default.all.find(function (mascot) {
...
},{"./highlight":"highlight.js","./highlightcomment":"highlightcomment.js","./mascot":"mascot.js","./team":"team.js","./userHighlight":"userHighlight.js","babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}],"../../../.nvm/versions/node/v15.1.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../.nvm/versions/node/v15.1.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
